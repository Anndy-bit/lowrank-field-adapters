...
_generated 2026-07-20T01:27:47.598915+00:00_
...
- **VRAM peak**: 2031.3 MB
- **Throughput**: 5.78 tok/s
- **Total wall-clock**: 29.32 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.25339 | 1.50099 | -0.7524 |
| perplexity | 9.5199 | 4.4861 | -5.0338 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1566 → last 1.0885 (min 0.8940)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0.1489
- mean grad_nmf: 0.9627
- mean grad_stb: 0.2658

## Memory (RQ1)

- VRAM allocated: peak 2031 MB, median 896 MB
- CPU RAM: peak 13792 MB
- samples: 24615 @ ~100ms
