...
_generated 2026-07-15T03:44:48.222232+00:00_
...
- **VRAM peak**: 2268.3 MB
- **Throughput**: 5.19 tok/s
- **Total wall-clock**: 4.29 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.48094 | 2.08418 | -0.3968 |
| perplexity | 11.9525 | 8.038 | -3.9145 |

## Training dynamics

- optimizer steps: 3
- loss: first 2.5913 → last 1.4751 (min 1.4751)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0.3076
- mean grad_nmf: 2.079
- mean grad_stb: 0.09005

## Memory (RQ1)

- VRAM allocated: peak 2268 MB, median 985 MB
- CPU RAM: peak 12886 MB
- samples: 7361 @ ~100ms
