...
_generated 2026-07-16T02:55:47.166507+00:00_

## Headline

- **Model**: Qwen/Qwen2.5-7B-Instruct
- **GPU**: NVIDIA GeForce GTX 1050 (3.94 GB)
- **Trainable params**: 401,464 (0.0053% of 7,616,017,976)
- **VRAM peak**: 1585.3 MB
- **Throughput**: 5.11 tok/s
- **Total wall-clock**: 33.17 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.48204 | 1.92161 | -0.5604 |
| perplexity | 11.9657 | 6.8319 | -5.1338 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1572 → last 1.1883 (min 1.0817)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0
- mean grad_nmf: 0.6313
- mean grad_stb: 0

## Memory (RQ1)

- VRAM allocated: peak 1585 MB, median 239 MB
- CPU RAM: peak 13862 MB
- samples: 17758 @ ~100ms
