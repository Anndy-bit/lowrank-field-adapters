...
_generated 2026-07-16T04:17:14.698223+00:00_
...
- **VRAM peak**: 1974.0 MB
- **Throughput**: 5.41 tok/s
- **Total wall-clock**: 31.34 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.48146 | 2.45545 | -0.026 |
| perplexity | 11.9587 | 11.6516 | -0.3071 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1561 → last 1.3392 (min 1.3392)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0.3644
- mean grad_nmf: 0
- mean grad_stb: 0

## Memory (RQ1)

- VRAM allocated: peak 1974 MB, median 860 MB
- CPU RAM: peak 13858 MB
- samples: 17744 @ ~100ms
