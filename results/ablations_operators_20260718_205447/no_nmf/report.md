...
_generated 2026-07-19T04:21:27.632714+00:00_
...
- **VRAM peak**: 1864.3 MB
- **Throughput**: 6.43 tok/s
- **Total wall-clock**: 26.35 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.25346 | 1.61813 | -0.6353 |
| perplexity | 9.5207 | 5.0437 | -4.477 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1562 → last 1.1577 (min 1.0033)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0.2798
- mean grad_nmf: 0
- mean grad_stb: 0.5058

## Memory (RQ1)

- VRAM allocated: peak 1864 MB, median 854 MB
- CPU RAM: peak 13853 MB
- samples: 21045 @ ~100ms
