...
_generated 2026-07-19T06:00:02.589954+00:00_
...
- **VRAM peak**: 1603.9 MB
- **Throughput**: 6.21 tok/s
- **Total wall-clock**: 27.3 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.25361 | 1.61842 | -0.6352 |
| perplexity | 9.5221 | 5.0451 | -4.477 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1580 → last 1.1118 (min 0.9876)
...
- VRAM allocated: peak 1604 MB, median 239 MB
- CPU RAM: peak 13934 MB
- samples: 21565 @ ~100ms
