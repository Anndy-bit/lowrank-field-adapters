...
_generated 2026-07-16T10:43:14.293419+00:00_
...
- **VRAM peak**: 1598.0 MB
- **Throughput**: 5.03 tok/s
- **Total wall-clock**: 33.65 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.25347 | 1.5195 | -0.734 |
| perplexity | 9.5208 | 4.57 | -4.9508 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1561 → last 1.0882 (min 0.8851)
...
- VRAM allocated: peak 1598 MB, median 277 MB
- CPU RAM: peak 13831 MB
- samples: 25512 @ ~100ms
