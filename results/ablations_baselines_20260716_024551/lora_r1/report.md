...
_generated 2026-07-16T09:44:28.030961+00:00_
...
- **VRAM peak**: 1314.7 MB
- **Throughput**: 4.95 tok/s
- **Total wall-clock**: 34.22 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.25347 | 1.52199 | -0.7315 |
| perplexity | 9.5208 | 4.5814 | -4.9394 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1561 → last 1.1022 (min 0.8942)
...
- VRAM allocated: peak 1315 MB, median 247 MB
- CPU RAM: peak 13833 MB
- samples: 26906 @ ~100ms
