...
_generated 2026-07-16T11:40:00.338055+00:00_
...
- **VRAM peak**: 1605.9 MB
- **Throughput**: 5.56 tok/s
- **Total wall-clock**: 30.46 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.25347 | 1.51241 | -0.7411 |
| perplexity | 9.5208 | 4.5377 | -4.9831 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1561 → last 1.0945 (min 0.8906)
...
- VRAM allocated: peak 1606 MB, median 449 MB
- CPU RAM: peak 13866 MB
- samples: 24898 @ ~100ms
