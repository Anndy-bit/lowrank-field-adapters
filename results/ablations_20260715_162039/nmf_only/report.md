...
_generated 2026-07-16T01:22:23.978141+00:00_

## Headline

- **Model**: Qwen/Qwen2.5-7B-Instruct
- **GPU**: NVIDIA GeForce GTX 1050 (3.94 GB)
- **Trainable params**: 3,211,712 (0.0422% of 7,618,828,224)
- **VRAM peak**: 1580.5 MB
- **Throughput**: 5.43 tok/s
- **Total wall-clock**: 40.04 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.48138 | 1.71465 | -0.7667 |
| perplexity | 11.9577 | 5.5547 | -6.403 |

## Training dynamics

- optimizer steps: 50
- loss: first 3.4448 → last 1.2841 (min 1.0432)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0
- mean grad_nmf: 0.9091
- mean grad_stb: 0

## Memory (RQ1)

- VRAM allocated: peak 1580 MB, median 268 MB
- CPU RAM: peak 13930 MB
- samples: 20350 @ ~100ms
