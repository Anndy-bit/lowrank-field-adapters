...
_generated 2026-07-16T00:35:25.228042+00:00_
...
- **VRAM peak**: 2128.3 MB
- **Throughput**: 4.99 tok/s
- **Total wall-clock**: 43.61 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.48146 | 2.45468 | -0.0268 |
| perplexity | 11.9587 | 11.6427 | -0.316 |

## Training dynamics

- optimizer steps: 50
- loss: first 3.4440 → last 1.5353 (min 1.4249)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0.3794
- mean grad_nmf: 0
- mean grad_stb: 0

## Memory (RQ1)

- VRAM allocated: peak 2128 MB, median 856 MB
- CPU RAM: peak 13921 MB
- samples: 22229 @ ~100ms
