...
_generated 2026-07-15T22:07:07.724401+00:00_
...
- **Total wall-clock**: 38.84 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.48147 | 1.66963 | -0.8118 |
| perplexity | 11.9589 | 5.3102 | -6.6487 |

## Training dynamics

- optimizer steps: 50
- loss: first 3.4455 → last 1.2720 (min 0.9164)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0.1299
- mean grad_nmf: 0.9007
- mean grad_stb: 0.212

## Memory (RQ1)

- VRAM allocated: peak 2238 MB, median 910 MB
- CPU RAM: peak 14005 MB
- samples: 19888 @ ~100ms
