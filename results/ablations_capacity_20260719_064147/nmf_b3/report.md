...
_generated 2026-07-19T15:47:42.088467+00:00_
...
- **VRAM peak**: 1624.6 MB
- **Throughput**: 6.13 tok/s
- **Total wall-clock**: 27.65 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.25351 | 1.6835 | -0.57 |
| perplexity | 9.5211 | 5.3843 | -4.1368 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1580 → last 1.1549 (min 1.0435)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0
- mean grad_nmf: 0.7771
- mean grad_stb: 0

## Memory (RQ1)

- VRAM allocated: peak 1625 MB, median 217 MB
- CPU RAM: peak 13777 MB
- samples: 21794 @ ~100ms
