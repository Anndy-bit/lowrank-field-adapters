...
_generated 2026-07-19T14:57:27.435097+00:00_
...
- **VRAM peak**: 1996.4 MB
- **Throughput**: 5.98 tok/s
- **Total wall-clock**: 28.32 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.2535 | 1.51837 | -0.7351 |
| perplexity | 9.521 | 4.5648 | -4.9562 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1567 → last 1.1296 (min 0.9476)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0.1863
- mean grad_nmf: 0.6201
- mean grad_stb: 0.3181

## Memory (RQ1)

- VRAM allocated: peak 1996 MB, median 861 MB
- CPU RAM: peak 13756 MB
- samples: 22783 @ ~100ms
