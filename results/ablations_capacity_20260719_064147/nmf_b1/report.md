...
_generated 2026-07-19T12:26:58.024784+00:00_
...
- **VRAM peak**: 1615.4 MB
- **Throughput**: 6.72 tok/s
- **Total wall-clock**: 25.2 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.25342 | 1.72679 | -0.5266 |
| perplexity | 9.5203 | 5.6225 | -3.8978 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1567 → last 1.1812 (min 1.0782)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0
- mean grad_nmf: 0.6067
- mean grad_stb: 0

## Memory (RQ1)

- VRAM allocated: peak 1615 MB, median 199 MB
- CPU RAM: peak 13979 MB
- samples: 19923 @ ~100ms
