...
_generated 2026-07-19T16:38:39.454961+00:00_
...
- **Total wall-clock**: 28.56 min

## Quality (RQ2 gate — did it learn?)

| metric | base (init) | after | Δ |
|---|---|---|---|
| eval_loss | 2.25346 | 1.63889 | -0.6146 |
| perplexity | 9.5207 | 5.1495 | -4.3712 |

## Training dynamics

- optimizer steps: 38
- loss: first 3.1562 → last 1.1651 (min 1.0172)
- fp16 steps skipped by GradScaler (overflow warmup): 0
- mean grad_svmo: 0.2947
- mean grad_nmf: 0
- mean grad_stb: 0.4373

## Memory (RQ1)

- VRAM allocated: peak 1886 MB, median 864 MB
- CPU RAM: peak 13776 MB
- samples: 22426 @ ~100ms
